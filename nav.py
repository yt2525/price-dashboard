...
URL_PATTERNS = {
    ...
    "Seagm": {
        ...
        # Brands probed and CONFIRMED NOT on SeaGM under common slug patterns
        # (returns blank SPA shell, no .SKU_type element):
        #   Amazon, Spotify, Discord, Netflix, Roblox, YouTube,
        #   Pokemon Go, Flexepin, Binance, Nexon, GoCash, NCsoft NCoin,
        #   DaddySkins, Nutaku, GASH, MINT, Johren, Crypto Voucher,
        #   Gift Me Crypto, Strong IPTV, Perplexity AI, CapCut,
        #   WOW Prepaid GC, Valorant Points US.
        # When these brands hit the SEARCH_URLS fallback below, the search
        # page often shows zero results — that's expected, SeaGM simply
        # doesn't sell them. The dashboard will leave those cells blank.
    },
