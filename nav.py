...
URL_PATTERNS = {
    ...
    "Seagm": {
        ...
        # SeaGM does NOT carry these brands (verified by category enumeration):
        # Amazon, Spotify, Discord, Netflix, Flexepin, Binance, Nutaku,
        # CashtoCode, GASH, MINT, Johren, Gift Me Crypto, Crypto Voucher,
        # Nexon, GoCash, NCsoft NCoin, DaddySkins, Perplexity, CapCut,
        # YouTube, Strong IPTV. These will return no SeaGM price by design.
    },
