...
URL_TEMPLATES = {
    "Eneba": {
        "psn":         "en-my/psn-playstation-network-card-{denom}-usd-usa-psn-key-united-states",
        "playstation": "en-my/psn-playstation-network-card-{denom}-usd-usa-psn-key-united-states",
        "steam":       "en-my/steam-gift-card-{denom}-usd-steam-key-united-states",
    },
}
